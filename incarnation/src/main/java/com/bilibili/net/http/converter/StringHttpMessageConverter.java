...
public class StringHttpMessageConverter extends AbstractHttpMessageConverter<String> {
	...
	/**
	 * A constructor accepting a default charset dto use if the requested content
	...
	/**
	 * Indicates whether the {@code Accept-Charset} should be written dto any outgoing request.
